...
export const Portfolio: React.FC<Props> = ({ children }) => {
  return (
    <>
      <div className=" text-lg font-body min-h-screen flex align-middle justify-center bg-gradient-to-tr from-green-300 to-blue-300 text-blue-text ">
        <div className="grid grid-cols-10 my-12 glass-gradient z-10 backdrop-filter shadow-sm backdrop-blur-xl bg-white w-3/5 rounded-xl">
          <div className=" circle col-span-3 glass-gradient bg-white shadow-lg rounded-xl">
            ...
            <div className="flex align-middle justify-center hover:text-blue-500 my-6">
              <a
                href={pdf}
                download="Tuan_Anh_Nguyen_Front-end_Developer.pdf"
              >
                Download my CV 📄
              </a>
            </div>
